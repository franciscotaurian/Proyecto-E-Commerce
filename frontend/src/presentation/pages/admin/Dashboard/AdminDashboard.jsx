    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Link to="/admin/products" className="p-6 bg-white border-2 border-black rounded-lg hover-lift">
                    <h2 className="font-bold text-xl mb-2">Lista de Productos</h2>
                    <p className="text-gray-600">Ver, editar y eliminar productos</p>
                </Link>
