...
export const PaymentSuccess = () => {
    ...
    const isWhatsApp = order.isWhatsAppShipping();
        ...
        <div className="container mx-auto px-4 py-12 max-w-3xl">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-6">
                ...
                <p className="text-sm text-gray-700">
                    {isWhatsApp ? '📱 WhatsApp - Coordinación directa con el vendedor' : '📦 Envío a domicilio vía Send'}
                </p>
            </div>

            {/* Conditional: WhatsApp notification OR Send confirmation */}
            {isWhatsApp ? (
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center mb-6">
                    ...
                    <h3 className="font-bold text-lg mb-2 text-blue-800">¡Orden creada exitosamente!</h3>
                    <p className="text-sm text-blue-700 mb-2">
                        Orden <span className="font-semibold">#{order.orderId}</span>
                    </p>
                    <p className="text-sm text-blue-600">
                        📧 Te notificaremos por correo electrónico al momento de realizar el envío.
                    </p>
                </div>
            )}
